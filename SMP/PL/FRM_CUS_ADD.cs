       ...
       // قاعد البيانات بنممرها من خلال الجدول عندنا زوز حقول اسم وصوره  
        ...
        {  
            ...
            if (edit_name.Text=="")
            {
                ...
                dialog.txt_capation.Text = "اسم الهميل مطلوب";
                dialog.Show();
            }
            else
            {
                ...
                if(id==0)
                {
                    ...
                    db.TB_Cus.Add(tb_supp);// قمنا باعملية الاضافة في جدول قاعد البيانات
                    db.SaveChanges();//حفضها في قاعد البيانات

                    toast.txt_capation.Text = "تم اضافة عميل جديد";
                ...
                else
                {
                    ...
                    toast.txt_capation.Text = "تم تعديل العميل ";
                    toast.Show();// ثم عرضنه توست رسالة لنوضح للمستخدم تم الاضافة
